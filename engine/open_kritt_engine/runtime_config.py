...
RUNTIME_ENV_ALIASES = {
    ...
    "ENGINE_SCAN_RUNNER_CPUS": ("ENGINE_SCAN_RUNNER_CPUS",),
    "ENGINE_SCAN_RUNNER_OOM_SCORE_ADJ": ("ENGINE_SCAN_RUNNER_OOM_SCORE_ADJ",),
    "ENGINE_MEMORY_PRESSURE_EVICTION_ENABLED": ("ENGINE_MEMORY_PRESSURE_EVICTION_ENABLED",),
    ...
    "ENGINE_MODEL_FAILOVER_CHAIN": ("ENGINE_MODEL_FAILOVER_CHAIN",),
}
...
def ensure_runtime_config_file(data_dir: str | None = None) -> Path:
    ...
    values = {
        ...
        or "1536",
        "ENGINE_SCAN_RUNNER_CPUS": os.getenv("ENGINE_SCAN_RUNNER_CPUS") or "0",
        "ENGINE_SCAN_RUNNER_OOM_SCORE_ADJ": os.getenv("ENGINE_SCAN_RUNNER_OOM_SCORE_ADJ") or "500",
        "ENGINE_MEMORY_PRESSURE_EVICTION_ENABLED": os.getenv("ENGINE_MEMORY_PRESSURE_EVICTION_ENABLED") or "false",
        ...
        "ENGINE_MODEL_FAILOVER_CHAIN": os.getenv("ENGINE_MODEL_FAILOVER_CHAIN") or "",
    }
    ...
    lines = [
        ...
        "# ENGINE_CODEX_FAST_MODE requests the higher-cost Fast tier only for supported native Codex models.",
        ...
        "# ENGINE_SCAN_RUNNER_CPUS limits each runner's CPU share; 0 leaves CPU unlimited.",
        "# ENGINE_SCAN_RUNNER_OOM_SCORE_ADJ makes runners preferred OOM victims when positive.",
        "# ENGINE_MEMORY_PRESSURE_EVICTION_ENABLED sacrifices one new runner before aggregate OOM kills the engine.",
