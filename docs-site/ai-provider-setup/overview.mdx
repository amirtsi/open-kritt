...
**Codex**, **Claude Code**, **DeepSeek**, **OpenRouter**, and **xAI**; providers without
...
its DeepSeek, OpenRouter, and xAI keys synchronized with `.env`, and mirrors those keys
